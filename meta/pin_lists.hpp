...
struct pin_lists<cons<pio_pin<P1, L1>, cons<pio_pin<P1, L2>, R>>> {
    using type = concat_pins_t<cons<pio_pin<P1, L1 | L2>, R>>;
};

template<char P1, unsigned char L1, char P2, unsigned char L2, typename R>
struct pin_lists<cons<pio_pin<P1, L1>, cons<pio_pin<P2, L2>, R>>> {
    using type = cons<pio_pin<P1, L1>, concat_pins_t<cons<pio_pin<P2, L2>, R>>>;
};
